...
const calculate = () => {
    dateArr = [];
    if (a = document.querySelector("#checka").checked == true) { dateArr.push(psub4) };
    if (b = document.querySelector("#checkb").checked == true) { dateArr.push(psub3) };
    if (c = document.querySelector("#checkc").checked == true) { dateArr.push(psub2) };
    if (d = document.querySelector("#checkd").checked == true) { dateArr.push(psub1) };
    if (e = document.querySelector("#checke").checked == true) { dateArr.push(p) };
    if (f = document.querySelector("#checkf").checked == true) { dateArr.push(p1) };
    if (g = document.querySelector("#checkg").checked == true) { dateArr.push(p2) };
    if (h = document.querySelector("#checkh").checked == true) { dateArr.push(p3) };
    let firstDate;
    let endDate;
    ...
    } else if (dateArr.length > 1 && Date.parse(dateArr[dateArr.length - 1]) >= Date.parse(p)) {
        firstDate = dateArr[0];
    ...
    let highDueDate = moment(endDate).add(1, "year").subtract(3, "months").subtract(7, "days").format("MM-DD-YYYY");
    ...
    let etamRange = moment(mRange).subtract("3", "months").subtract("7", "days").add("1", "year").format("MM-DD-YYYY");
